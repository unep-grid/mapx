...
import * as ogcMeta from "#mapx/ogc_meta";
...
io.use((socket, next) => {
  ...
  socket.on("/client/theme/list/ids", use(ioThemeListIds));
  socket.on("/client/theme/save", use(ioThemeSave));
  socket.on("/client/theme/validate", use(ioThemeValidate));
  socket.on("/client/theme/validate/id", use(ioThemeValidateId));
...
app.get(
  "/get/source/external/selection/validate",
  source.mwValidateExternalMetadataSelection,
);
...
app.get("/ogc_meta", ogcMeta.mwLanding);
app.get("/ogc_meta/", ogcMeta.mwLanding);
app.get("/ogc_meta/conformance", ogcMeta.mwConformance);
app.get("/ogc_meta/collections", ogcMeta.mwCollections);
app.get("/ogc_meta/collections/:collectionId", ogcMeta.mwCollection);
app.get("/ogc_meta/collections/:collectionId/items", ogcMeta.mwItems);
app.get("/ogc_meta/collections/:collectionId/items/:id", ogcMeta.mwItem);
