...
mxSource("src/r/helpers/binding_source_browser.R")
mxSource("src/r/helpers/source_selection.R")
...
mxSource("src/r/helpers/db_encryption.R")
mxSource("src/r/helpers/db_insert.R")
mxSource("src/r/helpers/db_projects.R")
mxSource("src/r/helpers/db_update.R")
...
tryCatch(
  ...
  error = function(e) {
    ...
    #
    msg <- sprintf(
      "[EARLY-ERROR] API HOST PUBLIC: %1$s;\nERROR: %2$s",
