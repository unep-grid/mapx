...
--
CREATE ROLE mapxc;
ALTER ROLE mapxc WITH NOSUPERUSER NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'custom_pwd';
CREATE ROLE mapxr;
ALTER ROLE mapxr WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD :'read_pwd';
CREATE ROLE mapxw;
ALTER ROLE mapxw WITH NOSUPERUSER INHERIT CREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD :'write_pwd';
