...
Tile.Feature.read = function (pbf, end) {
    return pbf.readFields(Tile.Feature._readField, {id: 0, tags: [], type: 0, geometry: [], raster: null}, end);
};
Tile.Feature._readField = function (tag, obj, pbf) {
    ...
    else if (tag === 5) obj.raster = pbf.readBytes();
};
Tile.Feature.write = function (obj, pbf) {
    ...
    if (obj.raster) pbf.writeBytesField(5, obj.raster);
};
