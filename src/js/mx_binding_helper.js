...
$(document).on('shiny:connected', function(event) {
  ...
  */
  ...
  Shiny.addCustomMessageHandler('jedInit',mx.helpers.jedRender);// Render json-editor
  Shiny.addCustomMessageHandler('jedUpdate',mx.helpers.jedUpdate);// update json-editor with given values
