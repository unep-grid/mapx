...
(function(){
  ...
  JSONEditor.defaults.editors.arrayConfirmDelete = JSONEditor.defaults.editors.array.extend({
            ...
            value.forEach(function(row,j) {
              if(j===i) {
                ...
                if(thisRow.rows[j].tab === thisRow.active_tab) {
                  ...
                  if(thisRow.rows[j+1]) new_active_tab = thisRow.rows[j].tab;
                  // Otherwise, make the previous tab active if there is one
                  else if(j) new_active_tab = thisRow.rows[j-1].tab;
                }
